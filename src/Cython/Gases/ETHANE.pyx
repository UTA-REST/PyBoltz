...
cdef void Gas9(Gas*object):
    ...
    EOBY[object.NION - 1] = object.EION[object.NION - 1] * <float> (0.63)
    ...
    for I in range(object.EnergySteps):
        ...
        if EN > object.EION[1]:
            ...
            if object.QION[1][I] == 0:
                if EN <= XION[NIOND - 1]:
                    # fraction of QCOUNT
                    object.QION[1][I] = QCOUNT * <float>(0.4481)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[1][I] = QBB * <float>(0.4481)
        ...
        if EN > object.EION[2]:
            ...
            if object.QION[2][I] == 0:
                if EN <= XION[NIOND - 1]:
                    ...
                    # fraction of QCOUNT
                    object.QION[2][I] = QCOUNT * <float>(0.1104)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[2][I] = QBB * <float>(0.1104)
        ...
        if EN > object.EION[3]:
            ...
            if object.QION[3][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[3][I] = QCOUNT * <float>(0.01718)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[3][I] = QBB * <float>(0.01718)
        ...
        if EN > object.EION[4]:
            ...
            if object.QION[4][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[4][I] = QCOUNT * <float>(0.1283)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[4][I] = QBB * <float>(0.1283)
        ...
        if EN > object.EION[5]:
            ...
            if object.QION[5][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[5][I] = QCOUNT * <float>(0.07)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[5][I] = QBB * <float>(0.07)
        ...
        if EN > object.EION[6]:
            ...
            if object.QION[6][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[6][I] = QCOUNT * <float>(0.000011)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[6][I] = QBB * <float>(0.000011)
        ...
        if EN > object.EION[7]:
            ...
            if object.QION[7][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[7][I] = QCOUNT * <float>(0.00036)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[7][I] = QBB * <float>(0.00036)
        ...
        if EN > object.EION[8]:
            ...
            if object.QION[8][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[8][I] = QCOUNT * <float>(0.0066)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[8][I] = QBB * <float>(0.0066)
        ...
        if EN > object.EION[9]:
            ...
            if object.QION[9][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[9][I] = QCOUNT * <float>(0.0062)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[9][I] = QBB * <float>(0.0062)
        ...
        if EN > object.EION[10]:
            ...
            if object.QION[10][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[10][I] = QCOUNT * <float>(0.0745)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[10][I] = QBB * <float>(0.0745)
        ...
        if EN > object.EION[11]:
            ...
            if object.QION[11][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[11][I] = QCOUNT * <float>(0.0000055)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[11][I] = QBB * <float>(0.0000055)
        ...
        if EN > object.EION[12]:
            ...
            if object.QION[12][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[12][I] = QCOUNT * <float>(0.00037)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[12][I] = QBB * <float>(0.00037)
        ...
        if EN > object.EION[13]:
            ...
            if object.QION[13][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[13][I] = QCOUNT * <float>(0.000022)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[13][I] = QBB * <float>(0.000022)
        ...
        if EN > object.EION[14]:
            ...
            if object.QION[14][I] == 0:
                if EN <= XION[NIOND - 1]:
                    #USE FRACTION OF COUNTING IONISATION ABOVE 600 EV
                    # fraction of QCOUNT
                    object.QION[14][I] = QCOUNT * <float>(0.00011)
                else:
                    #USE BORN-BETHE X-SECTION ABOVE X[n] EV
                    object.QION[14][I] = QBB * <float>(0.00011)
        ...
        if EN > 0.0:
            ...
            object.QIN[0][I] = <float>(0.0045) * log((EFAC + 1.0) / (EFAC - 1.0)) / EN
        ...
        if EN > object.EIN[1]:
            ...
            object.QIN[1][I] = <float>(0.0045) * log((EFAC + 1.0) / (1.0 - EFAC)) / EN
        ...
        if EN > 0.0:
            object.QIN[6][I] = GasUtil.CALQINVISO(EN, NVIB3, YVIB3, XVIB3, APOP4 / (1 + APOP4), object.EIN[7], 1,
                                                  -1 * 5 * EN, 0)
            if EN > 10:
