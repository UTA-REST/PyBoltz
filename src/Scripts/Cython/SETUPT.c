...
static PyObject *__pyx_f_6SETUPT_SETUPT(struct __pyx_obj_8Magboltz_Magboltz *__pyx_v_object, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  CYTHON_UNUSED double __pyx_v_PIR2;
 ...
 *     if object.NMAX < 0:
 */
  __pyx_v_object->NMAX = (__pyx_v_object->NMAX * __pyx_v_NSCALE);
