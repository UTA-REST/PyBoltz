...
cdef void Gas5(Gas* object):
    ...
    object.E = [0.0, 1.0, 21.56454, 0.0, 0.0, 19.5]
    object.E[1] = 2.0 * EMASS / (20.1797 * AMU)

    EOBY[0:4] = [17.4, 36, 73, 500]
    object.EION[0:4] = [21.56454, 62.5275, 125.9508, 870.2]
    object.NC0[0:4] = [0, 1, 2, 2]
    object.EC0[0:4] = [0.0, 5.0, 10.0, 806.6]
    ...
    for I in range(object.NSTEP):
        ...
        if EN > object.EION[0]:
            object.QION[0][I] = GasUtil.CALQIONX(EN, NIOND, YIN1, XION, BETA2, 0.9594, CONST, object.DEN[I], C, AM2)
        ...
        if EN > object.EIN[1]:
            object.QIN[1][I] = GasUtil.CALQINBEF(EN, N1S4, Y1S4, X1S4, BETA2, GAMMA2, EMASS2, object.DEN[I], BBCONST,
                                                 object.EIN[1], object.E[2], 0.0118)
