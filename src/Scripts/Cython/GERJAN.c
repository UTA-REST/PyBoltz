...
static double __pyx_f_6GERJAN_random_uniform(void); /*proto*/
...
static double __pyx_f_6GERJAN_random_uniform(void) {
  double __pyx_v_r;
  double __pyx_r;
 ...
 *         RAN1 = random_uniform()
 */
  srand(((unsigned int)(__pyx_v_RDUM * 1000.0)));
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 5; __pyx_t_1+=2) {
    __pyx_t_2 = __Pyx_PyInt_From_long(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 15, __pyx_L1_error)
 ...
 *         TWOPI = 2.0 * API
 */
    __pyx_v_RAN1 = __pyx_f_6GERJAN_random_uniform();
 ...
 */
    __pyx_v_RAN2 = __pyx_f_6GERJAN_random_uniform();
 ...
 *         RNMX[J + 1] = sqrt(-1*log(RAN1)) * sin(RAN2 * TWOPI)
 */
    __pyx_t_3 = __Pyx_PyIndex_AsSsize_t(__pyx_v_J); if (unlikely((__pyx_t_3 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
 ...
 *         RNMX[J + 1] = sqrt(-1*log(RAN1)) * sin(RAN2 * TWOPI)             # <<<<<<<<<<<<<<
 */
    __pyx_t_2 = __Pyx_PyInt_AddObjC(__pyx_v_J, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
