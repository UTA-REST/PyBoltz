...
def SETUP(object):
    ...
    object.CF = np.zeros(shape=(4000, 960))
    object.EIN = np.zeros(960)
    object.TCF = np.zeros(4000)
    object.IARRY = np.zeros(960)
    object.RGAS = np.zeros(960)
    object.IPN = np.zeros(960)
    object.WPL = np.zeros(960)
    object.PENFRA = np.zeros(shape=(3, 960))
    object.TCFMAX = np.zeros(8)
    object.CFN = np.zeros(shape=(4000, 60))
    object.TCFN = np.zeros(4000)
    object.SCLENUL = np.zeros(60)
    object.PSCT = np.zeros(shape=(4000, 960))
    object.ANGCT = np.zeros(shape=(4000, 960))
    object.INDEX = np.zeros(960)
    object.NC0 = np.zeros(960)
    object.EC0 = np.zeros(960)
    object.NG1 = np.zeros(960)
    object.EG1 = np.zeros(960)
    object.NG2 = np.zeros(960)
    object.EG2 = np.zeros(960)
    object.WKLM = np.zeros(960)
    object.IPLAST = 0.0
    object.ISIZE = 0.0
    object.EFL = np.zeros(960)
    if object.BMAG == 0:
        return object
