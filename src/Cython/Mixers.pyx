...
cpdef Mixer(PyBoltz object):
    ...
    for IE in range(4000):
        ...
        for GasIndex in range(object.NumberOfGases):
            object.NullCollisionFreqT[IE][NP] = MixObject.Gases[GasIndex].Q[1][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
            ...
            if object.FinalElectronEnergy >= MixObject.Gases[GasIndex].E[2]:
                if MixObject.Gases[GasIndex].N_Ionization <= 1:
                    NP += 1
                    object.NullCollisionFreqT[IE][NP] = MixObject.Gases[GasIndex].Q[2][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                    ...
                    for KION in range(MixObject.Gases[GasIndex].N_Ionization):
                        NP += 1
                        object.NullCollisionFreqT[IE][NP] = MixObject.Gases[GasIndex].IonizationCrossSection[KION][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                        object.FCION[IE] = object.FCION[IE] + object.NullCollisionFreqT[IE][NP]
                        object.ScatteringParameterNT[IE][NP] = 0.5
                        object.AngleCutNT[IE][NP] = 1.0
                        object.INDEXNT[NP] = 0
                        if MixObject.Gases[GasIndex].KEL[2] == 1:
                            ...
                            object.ScatteringParameterNT[IE][NP] = MixObject.Gases[GasIndex].PEIonizationCrossSection[KION][IE]
                            object.INDEXNT[NP] = 2
            ...
            if object.FinalElectronEnergy >= MixObject.Gases[GasIndex].E[3]:
                if MixObject.Gases[GasIndex].N_Attachment <= 1:
                    NP += 1
                    object.NullCollisionFreqT[IE][NP] = MixObject.Gases[GasIndex].Q[3][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                    object.FCATT[IE] = object.FCATT[IE] + object.NullCollisionFreqT[IE][NP]
                    object.ScatteringParameterNT[IE][NP] = 0.5
                    object.AngleCutNT[IE][NP] = 1.0
                    if IE == 0:
                        RGAS = 1 + MixObject.Gases[GasIndex].E[1] / 2
                    ...
                    for JJ in range(int(MixObject.Gases[GasIndex].N_Attachment)):
                        NP += 1
                        object.NullCollisionFreqT[IE][NP] = MixObject.Gases[GasIndex].AttachmentCrossSection[JJ][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                        object.FCATT[IE] = object.FCATT[IE] + object.NullCollisionFreqT[IE][NP]
                        object.ScatteringParameterNT[IE][NP] = 0.5
                        object.AngleCutNT[IE][NP] = 1.0
                        if IE == 0:
            ...
            if MixObject.Gases[GasIndex].N_Inelastic > 0:
                for J in range(int(MixObject.Gases[GasIndex].N_Inelastic)):
                    NP = NP + 1
                    object.NullCollisionFreqT[IE][NP] = MixObject.Gases[GasIndex].InelasticCrossSectionPerGas[J][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                    object.ScatteringParameterNT[IE][NP] = 0.5
                    object.AngleCutNT[IE][NP] = 1.0
                    object.INDEXNT[NP] = 0
                    if MixObject.Gases[GasIndex].KIN[J] == 1:
                        ...
                        object.ScatteringParameterNT[IE][NP] = MixObject.Gases[GasIndex].PEInelasticCrossSectionPerGas[J][IE]
                        object.INDEXNT[NP] = 2
                    if IE == 0:
                        ...
                        object.PenningFractionNT[1][NP] = MixObject.Gases[GasIndex].PenningFraction[1][J] * 1.0e-16 / sqrt(3)
            ...
            for I in range(object.NumberOfGases):
                if MixObject.Gases[GasIndex].N_Null > 0:
                    for J in range(MixObject.Gases[GasIndex].N_Null):
                        ...
                        object.NullCollisionFreqNT[IE][NP] = MixObject.Gases[GasIndex].NullCrossSection[J][IE] * object.VMoleculesPerCm3PerGas[GasIndex] * \
                                               object.SCLENULNT[NP]
                        NP+=1
    ...
    for I in range(object.EnergySteps):
        ...
        for GasIndex in range(object.NumberOfGases):
            ...
            if MixObject.Gases[GasIndex].N_Ionization > 1:
                ...
                for KION in range(MixObject.Gases[GasIndex].N_Ionization):
                    object.IonizationCrossSection[GasIndex][I] += MixObject.Gases[GasIndex].IonizationCrossSection[KION][I] * object.MoleculesPerCm3PerGas[GasIndex]
...
cpdef MixerT(PyBoltz object):
    ...
    for IE in range(4000):
        for GasIndex in range(object.NumberOfGases):
            ...
            object.CF[GasIndex][IE][NP - 1] = MixObject.Gases[GasIndex].Q[1][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
            ...
            if object.FinalElectronEnergy >= MixObject.Gases[GasIndex].E[2]:
                if MixObject.Gases[GasIndex].N_Ionization <= 1:
                    NP += 1
                    object.CF[GasIndex][IE][NP - 1] = MixObject.Gases[GasIndex].Q[2][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                    ...
                    for KION in range(MixObject.Gases[GasIndex].N_Ionization):
                        NP += 1
                        object.CF[GasIndex][IE][NP - 1] = MixObject.Gases[GasIndex].IonizationCrossSection[KION][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                        object.FCION[IE] = object.FCION[IE] + object.CF[GasIndex][IE][NP - 1]
                        object.ScatteringParameter[GasIndex][IE][NP - 1] = 0.5
                        object.AngleCut[GasIndex][IE][NP - 1] = 1.0
                        object.INDEX[GasIndex][NP - 1] = 0
            ...
            if object.FinalElectronEnergy >= MixObject.Gases[GasIndex].E[3]:
                if MixObject.Gases[GasIndex].N_Attachment <= 1:
                    NP += 1
                    object.CF[GasIndex][IE][NP - 1] = MixObject.Gases[GasIndex].Q[3][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                    ...
                    for JJ in range(int(MixObject.Gases[GasIndex].N_Attachment)):
                        NP += 1
                        object.CF[GasIndex][IE][NP - 1] = MixObject.Gases[GasIndex].AttachmentCrossSection[JJ][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                        object.FCATT[IE] = object.FCATT[IE] + object.CF[GasIndex][IE][NP - 1]
                        object.ScatteringParameter[GasIndex][IE][NP - 1] = 0.5
                        object.AngleCut[GasIndex][IE][NP - 1] = 1.0
                        if IE == 0:
            ...
            if MixObject.Gases[GasIndex].N_Inelastic > 0:
                for J in range(int(MixObject.Gases[GasIndex].N_Inelastic)):
                    NP = NP + 1
                    object.CF[GasIndex][IE][NP - 1] = MixObject.Gases[GasIndex].InelasticCrossSectionPerGas[J][IE] * object.VMoleculesPerCm3PerGas[GasIndex]
                    object.ScatteringParameter[GasIndex][IE][NP - 1] = 0.5
                    object.AngleCut[GasIndex][IE][NP - 1] = 1.0
                    object.INDEX[GasIndex][NP - 1] = 0
                    if MixObject.Gases[GasIndex].KIN[J] == 1:
            ...
            for p in range(int(object.NumMomCrossSectionPoints[GasIndex])):
                object.TotalCollisionFrequency[GasIndex][IE] = object.TotalCollisionFrequency[GasIndex][IE] + object.CF[GasIndex][IE][p]
            ...
            for p in range(int(object.NumMomCrossSectionPoints[GasIndex])):
                if object.TotalCollisionFrequency[GasIndex][IE] == 0:
                    ...
                    object.CF[GasIndex][IE][p] = object.CF[GasIndex][IE][p] / object.TotalCollisionFrequency[GasIndex][IE]
    ...
    tt = 0
    FAKEnergyLevels = abs(object.FAKEI) / object.NumberOfGases
    for GasIndex in range(object.NumberOfGases):
