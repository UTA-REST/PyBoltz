...
cdef class Magboltz:
    cdef public:
        ...
        double DTOVMB,DTMN,DFTER1,DLOVMB,DLMN,DFLER1,IPLAST1,ISIZE1
        double PIR2

        ## NO THERMAL MOTION
        double CF1[4000][960],EIN1[960],TCF1[4000],IARRY1[960],RGAS1[960],IPN1[960],WPL1[960],PENFRA1[3][960],TCFMAX1[8]
        double CFN1[4000][60],TCFN1[4000],SCLENUL1[60],PSCT1[4000][960],ANGCT1[4000][960],INDEX1[960],NC01[960],EC01[960]
        double NG11[960],EG11[960],NG21[960],EG21[960],WKLM1[960],EFL1[960]
        double ICOLL1[30],ICOLN1[960],ICOLNN1[60]
        double NPLAST1
