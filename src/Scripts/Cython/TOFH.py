...
def TOFH(Magboltz,JPRT):
    ...
    DYZTF[0] = ((Magboltz.YZTPL[0] / ANTPL[0]) - (Magboltz.YTPL[0] * Magboltz.ZTPL[0] / (ANTPL[0] ** 2))) / (
            2 * Magboltz.TSTEP)
    DXZTF[0] = ((Magboltz.XZTPL[0] / ANTPL[0]) - (Magboltz.XTPL[0] * Magboltz.ZTPL[0] / (ANTPL[0] ** 2))) / (
            2 * Magboltz.TSTEP)
    DXYTF[0] = ((Magboltz.XZTPL[0] / ANTPL[0]) - (Magboltz.XTPL[0] * Magboltz.YTPL[0] / (ANTPL[0] ** 2))) / (
            2 * Magboltz.TSTEP)
    ...
    for I in range(1, Magboltz.ITFINAL):
        ...
        WRX[I] = ((Magboltz.XTPL[I] / ANTPL[I]) - (Magboltz.XTPL[I - 1] / ANTPL[I - 1])) / Magboltz.TSTEP
        ...
        DYZTF[I] = ((Magboltz.YZTPL[I] / ANTPL[I]) - (Magboltz.YTPL[I] * Magboltz.ZTPL[I] / (ANTPL[I] ** 2)) - (
                Magboltz.YZTPL[I - 1] / ANTPL[I - 1]) + (
                           ...
                           2 * Magboltz.TSTEP)
        DXZTF[I] = ((Magboltz.XZTPL[I] / ANTPL[I]) - (Magboltz.XTPL[I] * Magboltz.ZTPL[I] / (ANTPL[I] ** 2)) - (
                Magboltz.XZTPL[I - 1] / ANTPL[I - 1]) + (
                            Magboltz.XTPL[I - 1] * Magboltz.ZTPL[I - 1] / (ANTPL[I - 1] ** 2))) / (
                           2 * Magboltz.TSTEP)
        DXYTF[I] = ((Magboltz.XYTPL[I] / ANTPL[I]) - (Magboltz.XTPL[I] * Magboltz.YTPL[I] / (ANTPL[I] ** 2)) - (
                Magboltz.XYTPL[I - 1] / ANTPL[I - 1]) + (
                            Magboltz.XTPL[I - 1] * Magboltz.YTPL[I - 1] / (ANTPL[I - 1] ** 2))) / (
                           2 * Magboltz.TSTEP)
    ...
    if Magboltz.NETPL[0] > Magboltz.NETPL[Magboltz.ITFINAL]:
        ...
        Magboltz.TOFWVX = Magboltz.VXPT[1]
        Magboltz.TOFWVXER = 100 * abs((Magboltz.VXPT[1] - Magboltz.VXPT[2]) / (2 * Magboltz.VXPT[1]))
        ...
        Magboltz.TOFDXZ = DXZTF[1]
        Magboltz.TOFDXZER = 100 * abs((DXZTF[1] - DXZTF[2]) / (2 * DXZTF[1]))
        Magboltz.TOFDXY = DXYTF[1]
        Magboltz.TOFDXYER = 100 * abs((DXYTF[1] - DXYTF[2]) / (2 * DXYTF[1]))
        Magboltz.TOFWRZ = WRZ[1]
        Magboltz.TOFWRY = WRY[1]
        Magboltz.TOFWRX = WRX[1]
        Magboltz.TOFWRZER = 100 * abs((WRZ[1] - WRZ[2])) / (2 * WRZ[1])
        Magboltz.TOFWRYER = 100 * abs((WRY[1] - WRY[2])) / (2 * WRY[1])
        Magboltz.TOFWRXER = 100 * abs((WRX[1] - WRX[2])) / (2 * WRX[1])
        ...
        Magboltz.TOFWVX = Magboltz.VXPT[I1]
        Magboltz.TOFWVXER = 100 * abs((Magboltz.VXPT[I1] - Magboltz.VXPT[I2]) / Magboltz.VXPT[I1])
        ...
        Magboltz.TOFDXZ = DXZTF[I1]
        Magboltz.TOFDXZER = 100 * abs((DXZTF[I1] - DXZTF[I2]) / DXZTF[I1])
        Magboltz.TOFDXY = DXYTF[I1]
        Magboltz.TOFDXYER = 100 * abs((DXYTF[I1] - DXYTF[I2]) / DXYTF[I1])
        Magboltz.TOFWRZ = WRZ[I1]
        Magboltz.TOFWRY = WRY[I1]
        Magboltz.TOFWRX = WRX[I1]
        Magboltz.TOFWRYER = 100 * abs((WRY[I1] - WRY[I2]) / WRY[I1])
        Magboltz.TOFWRZER = 100 * abs((WRZ[I1] - WRZ[I2]) / WRZ[I1])
        Magboltz.TOFWRXER = 100 * abs((WRX[I1] - WRX[I2]) / WRX[I1])
